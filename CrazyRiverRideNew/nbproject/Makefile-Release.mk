...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/crazyriverridenew

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/crazyriverridenew: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/crazyriverridenew ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/CampoDeJuego.o: CampoDeJuego.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CampoDeJuego.o CampoDeJuego.cpp
...
${OBJECTDIR}/ListaSimple.o: ListaSimple.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaSimple.o ListaSimple.cpp
...
${OBJECTDIR}/ObjetoMovil.o: ObjetoMovil.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ObjetoMovil.o ObjetoMovil.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/crazyriverridenew
